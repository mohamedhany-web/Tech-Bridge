...
<div class="space-y-8">
    ...
    @if($subjects->count() > 0)
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            @foreach($subjects as $index => $subject)
                ...
                @endphp
                <a href="{{ route('subjects.courses', $subject) }}" class="group relative bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden">
                    ...
                    <div class="relative p-6 space-y-5">
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            @if($frameworks->isNotEmpty())
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300 text-xs font-semibold">
                        ...
                        @if($languages->isNotEmpty() || $frameworks->isNotEmpty() || $levels->isNotEmpty())
                            <div class="bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-700 p-4 space-y-3">
                                @if($languages->isNotEmpty())
                                    <div class="flex items-start gap-3">
    ...
    @else
        <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl shadow-xl p-12 text-center space-y-4">
            ...
            <h3 class="text-2xl font-bold text-gray-900 dark:text-white">لم يتم إعداد مجموعات مهارية بعد</h3>
