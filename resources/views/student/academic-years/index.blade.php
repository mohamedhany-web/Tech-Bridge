...
<div class="space-y-8">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div class="space-y-4 max-w-3xl">
                    <span class="inline-flex items-center gap-2 bg-white/15 text-white px-4 py-2 rounded-full text-sm font-medium backdrop-blur-md">
                        ...
                        اكتشف مسارات Tech Bridge التعليمية
                    </span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            @foreach($tracks as $index => $track)
                ...
                <a href="{{ route('academic-years.subjects', $track) }}"
                   class="group relative bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden">
                    ...
                    <div class="relative p-6 space-y-6">
                        <div class="flex items-start justify-between gap-4">
                            <div>
                                ...
                                <div class="flex flex-wrap items-center gap-2">
                                    ...
                                    @if(!empty($metrics['avg_duration']))
                                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300 text-xs font-semibold">
                            ...
                            <div class="text-right">
                                <span class="inline-flex items-center gap-2 text-sm font-semibold text-sky-600 dark:text-sky-400">
                                    استعرض المسار
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            @foreach($levels as $level)
                                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-slate-200 text-slate-700 dark:bg-slate-800 dark:text-slate-200 capitalize">
                                                    {{ __($level) }}
                                                </span>
                                            @endforeach
                                        </div>
    ...
    @else
        <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl shadow-xl p-12 text-center space-y-4">
            ...
            <h3 class="text-2xl font-bold text-gray-900 dark:text-white">لم يتم إعداد المسارات بعد</h3>
