...
<div class="space-y-8">
    <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl shadow-xl overflow-hidden">
        <div class="px-6 py-8 sm:px-10 sm:py-10">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                ...
                @if($academicSubject->academicYear)
                <a href="{{ route('academic-years.subjects', $academicSubject->academicYear) }}" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-slate-900 text-white hover:bg-slate-700 dark:bg-slate-700 dark:hover:bg-slate-600 transition-colors">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mt-8">
                <div class="bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-700 rounded-2xl p-5">
                    ...
                    <p class="text-3xl font-bold text-slate-900 dark:text-white mt-2">{{ $courseStats['total'] }}</p>
                </div>
                <div class="bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-700 rounded-2xl p-5">
                    <p class="text-sm text-slate-500 dark:text-slate-400">اللغات الأساسية</p>
                ...
                <div class="bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-700 rounded-2xl p-5">
                    <p class="text-sm text-slate-500 dark:text-slate-400">مدة التعلم المتوسطة</p>
    ...
    @else
        <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl shadow-xl p-12 text-center space-y-4">
            ...
            <h3 class="text-2xl font-bold text-gray-900 dark:text-white">لا توجد كورسات في هذه المجموعة حالياً</h3>
