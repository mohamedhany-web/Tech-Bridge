    ...
    <div id="exit-warning" class="hidden fixed inset-0 bg-black bg-opacity-75 z-50 flex items-center justify-center">
        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md mx-4">
            <div class="text-center">
                ...
                <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">تأكيد الخروج</h3>
                <p class="text-gray-600 dark:text-gray-400 mb-6">هل تريد الخروج من الدرس؟ سيتم حفظ تقدمك الحالي.</p>
...
function activateScreenshotProtection() {
    ...
    if (canvas) {
        ...
        ctx.fillText('Tech Bridge Academy', canvas.width/2, canvas.height/2);
