...
<div class="space-y-6">
                ...
                <div class="h-48 bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center">
                    ...
                    @else
                        <div class="text-center text-white">
                            ...
                            <p class="text-sm">{{ optional($course->academicSubject)->name ?? 'كورس' }}</p>
                        </div>
                    @endif
                </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-2 text-sm text-gray-600 dark:text-gray-400 mb-4">
                            <div class="flex items-center">
                                ...
                                <span>{{ optional($course->academicYear)->name ?? 'غير محدد' }}@if($course->academicSubject) - {{ $course->academicSubject->name }}@endif</span>
                            </div>
                            <div class="flex items-center">
    ...
    @else
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700 rounded-lg p-12 text-center">
            ...
            <p class="text-gray-500 dark:text-gray-400 mb-6">لم يتم تفعيل أي كورسات لك بعد. يمكنك تصفح الكورسات المتاحة وطلب تفعيلها.</p>
            <a href="{{ route('academic-years') }}" 
