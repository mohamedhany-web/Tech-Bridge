    ...
    <div class="flex items-center justify-between">
        <div>
            <nav class="text-sm text-gray-500 dark:text-gray-400 mb-2">
                ...
                <a href="{{ route('student.exams.index') }}" class="hover:text-primary-600">امتحاناتي</a>
                <span class="mx-2">/</span>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div class="xl:col-span-2 space-y-6">
                    ...
                    @if($exam->instructions)
                        <div class="mb-6">
                            ...
                            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                                <div class="text-blue-900 dark:text-blue-100 whitespace-pre-wrap">{{ $exam->instructions }}</div>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="space-y-4">
                            <div>
                                ...
                                <div class="text-sm text-gray-500 dark:text-gray-400">{{ optional($exam->course->academicSubject)->name ?? 'غير محدد' }}</div>
                            </div>
            ...
            @if($previousAttempts->count() > 0)
                <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h4 class="text-lg font-semibold text-gray-900 dark:text-white">محاولاتك السابقة</h4>
                    </div>
                    <div class="p-6">
                        <div class="overflow-x-auto">
                            <table class="min-w-full">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">المحاولة</th>
                                        <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">النتيجة</th>
                                        <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">الوقت المستغرق</th>
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    @foreach($previousAttempts as $index => $attempt)
                                        <tr>
                                            ...
                                            <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">{{ $attempt->formatted_time }}</td>
                                            <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">{{ $attempt->created_at->format('Y-m-d H:i') }}</td>
                                            <td class="px-4 py-3">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white">معلومات الامتحان</h4>
                </div>
                    ...
                    @if($exam->canAttempt(auth()->id()))
                        ...
                        <form action="{{ route('student.exams.start', $exam) }}" method="POST" id="start-exam-form">
                            ...
                            <button type="button" onclick="confirmStart()" 
                                    class="bg-primary-600 hover:bg-primary-700 text-white px-8 py-3 rounded-lg font-bold text-lg transition-colors">
        ...
        <div class="space-y-6">
            ...
            @if($previousAttempts->where('status', 'completed')->count() > 0)
                <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="p-6 space-y-4">
                        @php
                            $completedAttempts = $previousAttempts->where('status', 'completed');
        ...
        <div class="mt-3 text-center">
            ...
            <div class="items-center px-4 py-3">
                <button onclick="startExam()" 
                        class="px-4 py-2 bg-primary-600 text-white text-base font-medium rounded-md w-24 mr-2 hover:bg-primary-700 transition-colors">
                    ابدأ
                </button>
