<div class="flex flex-col h-full bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
    ...
    <div class="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-sky-50 to-slate-50 dark:from-gray-800 dark:to-gray-900">
        <div class="flex items-center gap-3">
            <div class="w-20 h-20 bg-transparent rounded-xl flex items-center justify-center relative overflow-hidden group p-1">
                <img src="{{ asset('images/Tech_Bridge_LOGO.png') }}" alt="Tech Bridge Logo" class="w-full h-full object-contain relative z-10" onerror="this.onerror=null; this.parentElement.innerHTML='<i class=\'fas fa-code text-sky-600 text-2xl relative z-10 rotate-animation\'></i>';">
            </div>
            <div>
                <h2 class="text-lg font-black text-gray-900 dark:text-white">Tech Bridge</h2>
    ...
    <nav class="flex-1 p-4 overflow-y-auto sidebar">
        <ul class="space-y-2">
            ...
            {{-- @if(auth()->user()->isAdmin())
                <!-- خرائط الأنظمة - معطل مؤقتاً -->
                <li x-data="{ open: {{ request()->routeIs('admin.systems.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" 
                        ...
                        <div class="flex items-center gap-3">
                            <i class="fas fa-map w-5 text-sky-600 dark:text-sky-400 group-hover:text-sky-600 dark:group-hover:text-sky-400"></i>
                            <span class="font-medium">خارطة الأنظمة</span>
                        </div>
                        <i class="fas fa-chevron-down transition-transform	duration-300 text-gray-400 dark:text-gray-500" :class="{ 'rotate-180': open }"></i>
                    </button>
                    <ul x-show="open" x-transition class="mt-2 mr-4 space-y-1 border-r border-sky-200 dark:border-sky-700/40 pr-3">
                        <li>
                            <a href="{{ route('admin.systems.courses') }}"
                               @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                               class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg transition-all duration-300 {{ request()->routeIs('admin.systems.courses') ? 'bg-gradient-to-r from-sky-100 to-slate-100 text-sky-700 font-semibold shadow-md border border-sky-100 dark:border-sky-700/60 dark:from-sky-500/25 dark:to-slate-600/25 dark:text-sky-200 dark:shadow-sky-900/40' : 'text-gray-600 hover:bg-gradient-to-r hover:from-sky-50 hover:to-slate-50 hover:text-sky-700 dark:text-gray-300 dark:hover:from-gray-700/70 dark:hover:to-gray-800/70 dark:hover:text-sky-200 border border-transparent dark:hover:border-sky-700/40' }}">
                                <i class="fas fa-graduation-cap w-4"></i>
                                <span>نظام الكورسات</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.systems.cms') }}"
                               @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                               class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg transition-all duration-300 {{ request()->routeIs('admin.systems.cms') ? 'bg-gradient-to-r from-sky-100 to-slate-100 text-sky-700 font-semibold shadow-md border border-sky-100 dark:border-sky-700/60 dark:from-sky-500/25 dark:to-slate-600/25 dark:text-sky-200 dark:shadow-sky-900/40' : 'text-gray-600 hover:bg-gradient-to-r hover:from-sky-50 hover:to-slate-50 hover:text-sky-700 dark:text-gray-300 dark:hover:from-gray-700/70 dark:hover:to-gray-800/70 dark:hover:text-sky-200 border border-transparent dark:hover:border-sky-700/40' }}">
                                <i class="fas fa-globe w-4"></i>
                                <span>نظام إدارة المحتوى</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.systems.billing') }}"
                               @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                               class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg transition-all duration-300 {{ request()->routeIs('admin.systems.billing') ? 'bg-gradient-to-r from-sky-100 to-slate-100 text-sky-700 font-semibold shadow-md border border-sky-100 dark:border-sky-700/60 dark:from-sky-500/25 dark:to-slate-600/25 dark:text-sky-200 dark:shadow-sky-900/40' : 'text-gray-600 hover:bg-gradient-to-r hover:from-sky-50 hover:to-slate-50 hover:text-sky-700 dark:text-gray-300 dark:hover:from-gray-700/70 dark:hover:to-gray-800/70 dark:hover:text-sky-200 border border-transparent dark:hover:border-sky-700/40' }}">
                                <i class="fas fa-file-invoice-dollar w-4"></i>
                                <span>نظام الفوترة والمحاسبة</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.systems.lectures') }}"
                               @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                               class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg transition-all duration-300 {{ request()->routeIs('admin.systems.lectures') ? 'bg-gradient-to-r from-sky-100 to-slate-100 text-sky-700 font-semibold shadow-md border border-sky-100 dark:border-sky-700/60 dark:from-sky-500/25 dark:to-slate-600/25 dark:text-sky-200 dark:shadow-sky-900/40' : 'text-gray-600 hover:bg-gradient-to-r hover:from-sky-50 hover:to-slate-50 hover:text-sky-700 dark:text-gray-300 dark:hover:from-gray-700/70 dark:hover:to-gray-800/70 dark:hover:text-sky-200 border border-transparent dark:hover:border-sky-700/40' }}">
                                <i class="fas fa-chalkboard-teacher w-4"></i>
                                <span>نظام المحاضرات والجروبات</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.systems.smart-payments') }}"
                               @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                               class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg transition-all duration-300 {{ request()->routeIs('admin.systems.smart-payments') ? 'bg-gradient-to-r from-sky-100 to-slate-100 text-sky-700 font-semibold shadow-md border border-sky-100 dark:border-sky-700/60 dark:from-sky-500/25 dark:to-slate-600/25 dark:text-sky-200 dark:shadow-sky-900/40' : 'text-gray-600 hover:bg-gradient-to-r hover:from-sky-50 hover:to-slate-50 hover:text-sky-700 dark:text-gray-300 dark:hover:from-gray-700/70 dark:hover:to-gray-800/70 dark:hover:text-sky-200 border border-transparent dark:hover:border-sky-700/40' }}">
                                <i class="fas fa-wallet w-4"></i>
                                <span>نظام الدفع الذكي</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.systems.extra') }}"
                               @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
            ...
            @hasAnyPermission('manage.users', 'manage.orders', 'view.activity-log', 'view.statistics', 'manage.roles', 'manage.permissions', 'manage.user-permissions')
                <!-- إدارة النظام -->
                <li x-data="{ open: {{ request()->routeIs('admin.*') && !request()->routeIs('admin.academic-years.*', 'admin.advanced-courses.*', 'admin.enrollments.*', 'admin.exams.*', 'admin.question-bank.*', 'admin.question-categories.*', 'admin.invoices.*', 'admin.payments.*', 'admin.coupons.*', 'admin.certificates.*', 'admin.achievements.*', 'admin.reviews.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" 
                            class="flex items-center justify-between w-full px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-sky-50 hover:to-slate-50 dark:hover:from-gray-700 dark:hover:to-gray-800 transition-all duration-300 text-gray-700 dark:text-gray-300 group">
                        <div class="flex items-center gap-3">
            ...
            @hasAnyPermission('manage.invoices', 'manage.payments', 'manage.transactions', 'manage.wallets', 'manage.subscriptions', 'manage.installments', 'manage.expenses')
                <!-- إدارة المحاسبة -->
                <li x-data="{ open: {{ request()->routeIs('admin.invoices.*', 'admin.payments.*', 'admin.transactions.*', 'admin.wallets.*', 'admin.subscriptions.*', 'admin.installments.*', 'admin.expenses.*', 'admin.accounting.reports') ? 'true' : 'false' }} }">
                    <button @click="open = !open" 
                            class="flex items-center justify-between w-full px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-sky-50 hover:to-slate-50 dark:hover:from-gray-700 dark:hover:to-gray-800 transition-all duration-300 text-gray-700 dark:text-gray-300 group">
                        <div class="flex items-center gap-3">
                    ...
                    <ul x-show="open" x-transition class="mt-2 mr-4 space-y-1 border-r-2 border-sky-200 dark:border-sky-800 pr-2">
                        ...
                        <li x-data="{ open: {{ request()->routeIs('admin.installments.plans.*', 'admin.installments.agreements.*') ? 'true' : 'false' }} }">
                            <button @click="open = !open"
            ...
            {{-- تم تعطيل قسم إدارة التسويق مؤقتاً - غير مستخدم حالياً --}}
            {{-- @hasAnyPermission('manage.coupons', 'manage.referrals', 'manage.loyalty')
                <!-- إدارة التسويق -->
                <li x-data="{ open: {{ request()->routeIs('admin.coupons.*', 'admin.referral-programs.*', 'admin.referrals.*', 'admin.loyalty.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" 
                            class="flex items-center justify-between w-full px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-sky-50 hover:to-slate-50 dark:hover:from-gray-700 dark:hover:to-gray-800 transition-all duration-300 text-gray-700 dark:text-gray-300 group">
                        <div class="flex items-center gap-3">
            ...
            @hasAnyPermission('manage.certificates', 'manage.achievements', 'manage.badges', 'manage.reviews')
                ...
                <li x-data="{ open: {{ request()->routeIs('admin.certificates.*', 'admin.achievements.*', 'admin.badges.*', 'admin.reviews.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" 
                            class="flex items-center justify-between w-full px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-sky-50 hover:to-slate-50 dark:hover:from-gray-700 dark:hover:to-gray-800 transition-all duration-300 text-gray-700 dark:text-gray-300 group">
                        <div class="flex items-center gap-3">
            ...
            @hasAnyPermission('manage.academic-years', 'manage.academic-subjects', 'manage.courses', 'manage.enrollments', 'manage.lectures', 'manage.groups', 'manage.assignments', 'manage.exams', 'manage.question-bank')
                <!-- إدارة المحتوى -->
                <li x-data="{ open: {{ request()->routeIs('admin.academic-years.*', 'admin.advanced-courses.*', 'admin.enrollments.*', 'admin.exams.*', 'admin.question-bank.*', 'admin.question-categories.*', 'admin.lectures.*', 'admin.groups.*', 'admin.assignments.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" 
                            class="flex items-center justify-between w-full px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-sky-50 hover:to-slate-50 dark:hover:from-gray-700 dark:hover:to-gray-800 transition-all duration-300 text-gray-700 dark:text-gray-300 group">
                        <div class="flex items-center gap-3">
            ...
            @hasAnyPermission('manage.roles', 'manage.permissions', 'manage.user-permissions')
                ...
                <li x-data="{ open: {{ request()->routeIs('admin.roles.*', 'admin.permissions.*', 'admin.user-permissions.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" 
                            class="flex items-center justify-between w-full px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-sky-50 hover:to-slate-50 dark:hover:from-gray-700 dark:hover:to-gray-800 transition-all duration-300 text-gray-700 dark:text-gray-300 group">
                        <div class="flex items-center gap-3">
            ...
            {{-- @hasPermission('view.wallets')
                <!-- إدارة المحافظ الذكية - تم إزالتها لأنها موجودة في إدارة المحاسبة -->
                <li>
            ...
            @hasAnyPermission('manage.blog', 'manage.contact-messages')
                <!-- إدارة الصفحات الخارجية -->
                <li x-data="{ open: {{ request()->routeIs('admin.blog.*', 'admin.contact-messages.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" 
                            class="flex items-center justify-between w-full px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-sky-50 hover:to-slate-50 dark:hover:from-gray-700 dark:hover:to-gray-800 transition-all duration-300 text-gray-700 dark:text-gray-300 group">
                        <div class="flex items-center gap-3">
                    ...
                    <ul x-show="open" x-transition class="mt-2 mr-4 space-y-1 border-r-2 border-sky-200 dark:border-sky-800 pr-2">
                        ...
                        @endhasPermission
                        {{-- تم إزالة قسم إدارة الباقات والأسعار - غير مستخدم حالياً --}}
            ...
            @hasRole('student')
                ...
                <li>
                    <a href="{{ route('academic-years') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 relative overflow-hidden group {{ request()->routeIs('academic-years*', 'subjects.*', 'courses.*') ? 'bg-gradient-to-r from-sky-500 to-sky-600 text-white shadow-lg shadow-sky-500/30' : 'text-gray-700 dark:text-gray-300 hover:bg-gradient-to-r hover:from-sky-50 hover:to-slate-50 dark:hover:from-gray-700 dark:hover:to-gray-800' }}">
                        <div class="absolute inset-0 bg-gradient-to-r from-sky-400 to-slate-400 opacity-0 group-hover:opacity-10 transition-opacity duration-300"></div>
                        <i class="fas fa-search w-5 relative z-10 {{ request()->routeIs('academic-years*', 'subjects.*', 'courses.*') ? 'text-white' : 'text-sky-600 dark:text-sky-400 group-hover:text-sky-600 dark:group-hover:text-sky-400' }}"></i>
                        <span class="relative z-10 font-semibold">تصفح الكورسات</span>
                        @if(request()->routeIs('academic-years*', 'subjects.*', 'courses.*'))
                            <div class="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-sky-400 to-slate-400 rounded-r"></div>
                        @endif
                    </a>
                </li>
