                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="academic_subject_id" id="academic_subject_id"
                                        class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white">
                                    <option value="">بدون مجموعة مهارية</option>
                                ...
                                <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    <div>
                                        ...
                                        <div class="text-sm text-gray-500 dark:text-gray-400">
                                            {{ $category->academicYear->name ?? 'غير محدد' }}@if($category->academicSubject) - {{ $category->academicSubject->name }}@endif
                                        </div>
                                    </div>
                                    <div class="text-sm text-gray-500 dark:text-gray-400">
...
function loadSubjects() {
    ...
    subjectSelect.innerHTML = '<option value="">بدون مجموعة مهارية</option>';
