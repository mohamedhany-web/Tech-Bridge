...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6">
            <div class="flex justify-between items-start mb-6">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mt-2">المستخدم: {{ $task->user->name }}</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                    <p class="text-sm text-gray-600 dark:text-gray-400">الأولوية</p>
                    <p class="mt-2">
                ...
                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                    <p class="text-sm text-gray-600 dark:text-gray-400">تاريخ الاستحقاق</p>
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">
                        {{ $task->due_date ? $task->due_date->format('Y-m-d H:i') : '-' }}
                        @if($task->due_date && $task->due_date->isPast() && $task->status != 'completed')
                            <span class="text-red-600 dark:text-red-400 text-sm block">متأخرة</span>
                        @endif
                    </p>
                </div>
            </div>
            ...
            <div class="mb-6">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">مرتبطة بـ</h3>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4">التعليقات</h2>
            ...
            <div class="space-y-4 mb-6">
                ...
                @empty
                <p class="text-gray-500 dark:text-gray-400 text-center py-4">لا توجد تعليقات</p>
                @endforelse
            </div>
