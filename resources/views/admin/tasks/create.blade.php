...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">إضافة مهمة جديدة</h1>
            ...
            <form action="{{ route('admin.tasks.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">الربط</label>
                    ...
                    <div class="flex items-center">
                        ...
                        <label class="mr-2 block text-sm text-gray-700 dark:text-gray-300">تذكير</label>
                    </div>

                    <div id="reminder-date" style="display: none;">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">تاريخ التذكير</label>
