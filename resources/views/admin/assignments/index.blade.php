    ...
    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">إدارة الواجبات والمشاريع</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">إدارة الواجبات والتصحيحات</p>
                </div>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-700/50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">الكورس/المحاضرة</th>
                        ...
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">التسليمات</th>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            <td class="px-6 py-4">
                                ...
                                @if($assignment->description)
                                    <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ Str::limit($assignment->description, 50) }}</div>
                                @endif
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300">
                                {{ $assignment->due_date ? $assignment->due_date->format('Y-m-d H:i') : '-' }}
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center gap-3">
                                    <a href="{{ route('admin.assignments.show', $assignment) }}" class="text-sky-600 hover:text-sky-800 dark:text-sky-400 dark:hover:text-sky-300" title="عرض">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.assignments.submissions', $assignment) }}" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300" title="التسليمات">
                                        <i class="fas fa-list"></i>
                                    </a>
                                    <a href="{{ route('admin.assignments.edit', $assignment) }}" class="text-emerald-600 hover:text-emerald-800 dark:text-emerald-400 dark:hover:text-emerald-300" title="تعديل">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center text-gray-500 dark:text-gray-400">
                                    ...
                                    <p class="font-medium">لا توجد واجبات</p>
                                    <p class="text-sm mt-1">ابدأ بإضافة واجب جديد</p>
                                    <a href="{{ route('admin.assignments.create') }}" class="mt-4 inline-flex items-center px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-lg text-sm font-medium transition-colors">
                                        <i class="fas fa-plus ml-2"></i>
                                        إضافة واجب
                                    </a>
                                </div>
