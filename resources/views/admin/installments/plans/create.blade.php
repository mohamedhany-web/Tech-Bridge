...
@section('title', 'إضافة خطة تقسيط جديدة - Tech Bridge')
        ...
        <div class="bg-white dark:bg-gray-900 rounded-3xl shadow-lg border border-gray-100 dark:border-gray-800 p-8">
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">أدخل التفاصيل الأساسية، ثم تابع بتحديد الأقساط والدورية.</p>
                </div>
            </div>
            ...
            <form action="{{ route('admin.installments.plans.store') }}" method="POST" class="space-y-8">
                ...
                <div class="flex items-center justify-end gap-3">
                    <a href="{{ route('admin.installments.plans.index') }}" class="px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">إلغاء</a>
