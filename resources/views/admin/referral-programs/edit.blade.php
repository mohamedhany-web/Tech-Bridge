...
@section('title', 'تعديل برنامج الإحالات - Tech Bridge')
...
<div class="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
    <div class="max-w-4xl mx-auto">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">تعديل برنامج الإحالات: {{ $referralProgram->name }}</h1>
            ...
            <form action="{{ route('admin.referral-programs.update', $referralProgram) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-sky-500 dark:bg-gray-700 dark:text-white transition-all">{{ old('description', $referralProgram->description) }}</textarea>
                </div>
