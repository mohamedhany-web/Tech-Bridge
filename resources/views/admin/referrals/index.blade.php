...
@section('title', 'الإحالات - Tech Bridge')
...
<div class="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
    ...
    <div class="mb-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400">عرض وإدارة جميع الإحالات والعمولات</p>
            </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
        ...
        <div class="bg-gradient-to-br from-sky-50 to-slate-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-xl p-6 border border-sky-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 card-hover-effect relative overflow-hidden group">
            ...
            <div class="relative z-10">
                ...
                <div class="mt-4 flex items-center text-sm">
                    <i class="fas fa-chart-line text-sky-500 dark:text-sky-400 ml-2"></i>
        ...
        <div class="bg-gradient-to-br from-emerald-50 to-green-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-xl p-6 border border-emerald-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 card-hover-effect relative overflow-hidden group">
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex-1">
                        <p class="text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1">مكتملة</p>
                        <p class="text-4xl font-black text-emerald-600 dark:text-emerald-400">{{ number_format($stats['completed']) }}</p>
                    </div>
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex-1">
                        ...
                        <p class="text-4xl font-black text-amber-600 dark:text-amber-400">{{ number_format($stats['pending']) }}</p>
                    </div>
        ...
        <!-- إجمالي الخصومات -->
        <div class="bg-gradient-to-br from-rose-50 to-pink-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-xl p-6 border border-rose-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 card-hover-effect relative overflow-hidden group">
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex-1">
                        <p class="text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1">إجمالي الخصومات</p>
                        <p class="text-3xl font-black text-rose-600 dark:text-rose-400">{{ number_format($stats['total_discounts'], 2) }} ج.م</p>
                    </div>
                ...
                <div class="mt-4 flex items-center text-sm">
                    <i class="fas fa-percent text-rose-500 dark:text-rose-400 ml-2"></i>
                    <span class="text-gray-600 dark:text-gray-400 font-medium">خصومات مطبقة</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 mb-8 border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 card-hover-effect">
        <div class="flex items-center gap-3 mb-6 pb-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-sky-50 to-slate-50 dark:from-gray-800 dark:to-gray-800 -m-6 p-6 rounded-t-2xl">
            <i class="fas fa-filter text-sky-600 dark:text-sky-400"></i>
            <h3 class="text-lg font-black text-gray-900 dark:text-white">فلترة وبحث الإحالات</h3>
        </div>
        <form method="GET" action="{{ route('admin.referrals.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <select name="status" class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-sky-500 dark:bg-gray-700 dark:text-white transition-all">
            ...
            <div>
                ...
                <select name="program_id" class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-sky-500 dark:bg-gray-700 dark:text-white transition-all">
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="{{ route('admin.referrals.index') }}" class="bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-white px-5 py-3 rounded-xl font-medium transition-colors">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 card-hover-effect">
        <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-sky-50 to-slate-50 dark:from-gray-800 dark:to-gray-800">
            <h3 class="text-lg font-black text-gray-900 dark:text-white flex items-center gap-2">
                <i class="fas fa-list text-sky-600 dark:text-sky-400"></i>
                قائمة الإحالات
            </h3>
        </div>
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">المحيل</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">المحال</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">البرنامج</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">كود الإحالة</th>
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="mr-4">
                                    <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $referral->referrer->name ?? 'غير معروف' }}</div>
                                    <div class="text-sm text-gray-500 dark:text-gray-400">{{ $referral->referrer->phone ?? 'N/A' }}</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm text-gray-900 dark:text-white">{{ $referral->referralProgram->name ?? '-' }}</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm font-mono font-bold text-gray-900 dark:text-white">{{ $referral->referral_code ?? $referral->code ?? '-' }}</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
    ...
    @else
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-16 text-center border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 card-hover-effect">
        ...
        <p class="text-gray-600 dark:text-gray-400 text-xl font-semibold mb-2">لا توجد إحالات</p>
        <p class="text-gray-500 dark:text-gray-500 text-sm mb-6">ابدأ بإنشاء برنامج إحالات لتفعيل نظام الإحالات</p>
