        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ $academicSubject->name }}</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400">{{ $academicSubject->academicYear->name ?? 'غير محدد' }}</p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 space-y-3">
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-600 dark:text-gray-400">اسم المجموعة:</span>
                            <span class="text-sm text-gray-900 dark:text-white">{{ $academicSubject->name }}</span>
                        </div>
                        
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-600 dark:text-gray-400">رمز المجموعة:</span>
                            <span class="text-sm text-gray-900 dark:text-white font-mono">{{ $academicSubject->code }}</span>
                        </div>
                        
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-600 dark:text-gray-400">المسار التعليمي:</span>
