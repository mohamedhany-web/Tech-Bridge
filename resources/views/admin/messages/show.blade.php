...
<div class="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
    ...
    <div class="mb-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400">{{ __('عرض تفاصيل الرسالة المرسلة عبر الواتساب') }}</p>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-200 dark:border-gray-700">
                <div class="p-6 bg-gradient-to-r from-sky-50 to-blue-50 dark:from-gray-700 dark:to-gray-800 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="p-6">
                    ...
                    <div class="bg-gradient-to-br from-green-50 via-green-50 to-green-100 dark:from-green-900/30 dark:via-green-900/20 dark:to-green-900/30 rounded-xl p-6 border-2 border-green-200 dark:border-green-800 shadow-lg">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    @elseif($message->status === 'delivered')
                                        <div class="text-blue-600 dark:text-blue-400 text-lg">
                                ...
                                <div class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border border-green-100 dark:border-gray-700 mb-3">
                                    <div class="text-gray-900 dark:text-white text-base whitespace-pre-wrap leading-relaxed">
                                        {{ $message->message }}
                                    </div>
                                </div>
                    ...
                    @if($message->error_message)
                        <div class="mt-6 p-5 bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900/30 dark:to-red-900/20 border-2 border-red-200 dark:border-red-800 rounded-xl shadow-lg">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    <div class="text-base font-bold text-red-700 dark:text-red-300 mb-2">
                                        {{ __('خطأ في الإرسال') }}:
                                    </div>
                                    <div class="text-red-600 dark:text-red-400 text-sm bg-white dark:bg-gray-800 rounded-lg p-3 border border-red-100 dark:border-gray-700">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 border border-gray-200 dark:border-gray-700">
                ...
                @if($message->user)
                    <div class="flex items-center mb-6 p-4 bg-gradient-to-r from-sky-50 to-blue-50 dark:from-gray-700 dark:to-gray-800 rounded-xl border border-sky-100 dark:border-gray-700">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                        ...
                        <span class="text-gray-900 dark:text-white font-semibold">{{ $message->phone_number }}</span>
                    </div>
                    <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                        <span class="text-gray-600 dark:text-gray-400 flex items-center gap-2">
                        ...
                        <span class="text-gray-900 dark:text-white font-semibold">{{ $message->type }}</span>
                    </div>
                    <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                        <span class="text-gray-600 dark:text-gray-400 flex items-center gap-2">
                        ...
                        <span class="text-gray-900 dark:text-white font-semibold">{{ $message->created_at->format('d/m/Y H:i') }}</span>
                    </div>
                    @if($message->sent_at)
                        <div class="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                            ...
                            <span class="text-gray-900 dark:text-white font-semibold">{{ $message->sent_at->format('d/m/Y H:i') }}</span>
                        </div>
                    @endif
                    @if($message->delivered_at)
                        <div class="flex items-center justify-between p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                            ...
                            <span class="text-gray-900 dark:text-white font-semibold">{{ $message->delivered_at->format('d/m/Y H:i') }}</span>
                        </div>
                    @endif
                </div>
            </div>
            ...
            @if($message->response_data)
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-600 shadow-inner">
                        <pre class="text-xs text-gray-700 dark:text-gray-300 overflow-x-auto font-mono leading-relaxed">{{ json_encode($message->response_data, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) }}</pre>
                    </div>
                </div>
            @endif
        </div>
