...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">إضافة محفظة جديدة</h1>
            ...
            <form action="{{ route('admin.wallets.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">اسم المحفظة *</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">نوع المحفظة *</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">رقم الحساب/المحفظة</label>
                    ...
                    <div id="bank-name-field" style="display: none;">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">اسم البنك</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">اسم صاحب الحساب</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">الرصيد الابتدائي</label>
                    ...
                    <div class="flex items-center">
                        ...
                        <label class="mr-2 block text-sm text-gray-700 dark:text-gray-300">المحفظة نشطة</label>
                    </div>
