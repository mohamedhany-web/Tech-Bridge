...
@section('title', 'إدارة المدونة - Tech Bridge')
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">إدارة المدونة</h1>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">إدارة مقالات المدونة</p>
                </div>
                <div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-900">
                        <tr>
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">المقال</th>
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">المؤلف</th>
                        ...
                        <tr>
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    @else
                                    <div class="h-12 w-12 rounded-lg bg-gray-200 dark:bg-gray-700 flex items-center justify-center ml-3">
                                        <i class="fas fa-image text-gray-400"></i>
                                    </div>
                                    @endif
                                    <div>
                                        <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $post->title }}</div>
                                        <div class="text-sm text-gray-500 dark:text-gray-400">{{ Str::limit($post->excerpt ?? Str::limit(strip_tags($post->content), 100), 60) }}</div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center space-x-2 space-x-reverse">
                                    <a href="{{ route('admin.blog.show', $post) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-900">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.blog.edit', $post) }}" class="text-sky-600 dark:text-sky-400 hover:text-sky-900">
