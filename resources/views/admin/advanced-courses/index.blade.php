...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">إدارة الكورسات البرمجية</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">إدارة وتنظيم كورسات البرمجة في الأكاديمية</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-gray-200 dark:border-gray-700">
                ...
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white truncate">{{ optional($course)->title ?? 'كورس' }}</h3>
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                            {{ optional($course)->is_active ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300' }}">
                            {{ optional($course)->is_active ? 'نشط' : 'معطل' }}
                        </span>
                    </div>
                </div>
                ...
                <!-- محتوى البطاقة -->
                <div class="px-6 py-4">
                    @if(optional($course)->description)
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center text-sm">
                            ...
                            <span class="text-gray-900 dark:text-white mr-2">{{ optional($course->academicYear)->name ?? 'غير محدد' }}</span>
                        </div>
                        ...
                        <div class="flex items-center text-sm">
                            ...
                            <span class="text-gray-900 dark:text-white mr-2">{{ optional($course->academicSubject)->name ?? 'غير محدد' }}</span>
                        </div>

                        <!-- السعر -->
                        @if(optional($course)->price)
                        <div class="flex items-center text-sm">
                        ...
                        <div class="flex items-center text-sm">
                            ...
                            <span class="text-gray-900 dark:text-white mr-2">{{ optional($course->created_at)->format('Y-m-d') ?? '-' }}</span>
                        </div>
                    </div>
                </div>
