...
@section('title', 'إدارة معرض الصور والفيديوهات - Tech Bridge')
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">إدارة معرض الصور والفيديوهات</h1>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">إدارة الصور والفيديوهات في المعرض</p>
                </div>
                <div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 rounded-lg overflow-hidden shadow hover:shadow-lg transition-shadow">
                        ...
                        <div class="p-4">
                            <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-1">{{ $item->title }}</h4>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mb-2">{{ $item->type === 'image' ? 'صورة' : 'فيديو' }}</p>
                            <div class="flex items-center justify-between mt-3">
                                <span class="text-xs text-gray-500 dark:text-gray-400">
                                    {{ $item->created_at->format('Y-m-d') }}
                                </span>
                                <div class="flex items-center space-x-2 space-x-reverse">
                                    <a href="{{ route('admin.media.show', $item) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-900">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.media.edit', $item) }}" class="text-sky-600 dark:text-sky-400 hover:text-sky-900">
