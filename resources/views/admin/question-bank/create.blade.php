                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <a href="{{ route('admin.question-categories.create') }}" target="_blank" class="text-xs text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                                    <i class="fas fa-plus ml-1"></i>
                                    إضافة تصنيف جديد
                                </a>
                            </div>
                            @if($categories->isEmpty())
                                <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 text-yellow-700 dark:text-yellow-300 px-4 py-3 rounded-lg mb-3">
                                    <p class="text-sm mb-2">
                                        <i class="fas fa-exclamation-triangle ml-1"></i>
                                        لا توجد تصنيفات متاحة. يجب إنشاء تصنيف أولاً قبل إضافة الأسئلة.
                                    </p>
                                    <a href="{{ route('admin.question-categories.create') }}" class="inline-flex items-center gap-2 px-3 py-1.5 bg-yellow-600 hover:bg-yellow-700 text-white rounded-lg text-sm font-medium transition-colors">
