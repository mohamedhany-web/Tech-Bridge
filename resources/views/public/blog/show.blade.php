...
@section('title', $post->title . ' - Tech Bridge')
@section('content')
<!-- Hero Section -->
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                <img src="{{ asset($post->featured_image) }}" alt="{{ $post->title }}" class="w-full rounded-xl shadow-lg max-h-96 object-cover" onerror="this.style.display='none'">
            </div>
            @else
