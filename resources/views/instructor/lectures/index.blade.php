...
@section('title', 'المحاضرات - Tech Bridge')
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1">إدارة محاضراتك والتحكم في الحضور والغياب</p>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-5 gap-4 mt-6">
            ...
            <div class="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-700 rounded-xl border border-blue-100 dark:border-gray-600">
                <div class="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wide">مجدولة</div>
                <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ $stats['scheduled'] ?? 0 }}</div>
            </div>
            ...
            <div class="p-4 bg-gradient-to-br from-amber-50 to-yellow-50 dark:from-gray-700 dark:to-gray-700 rounded-xl border border-amber-100 dark:border-gray-600">
                <div class="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wide">قيد التنفيذ</div>
                <div class="text-2xl font-bold text-amber-600 dark:text-amber-400">{{ $stats['in_progress'] ?? 0 }}</div>
            </div>
            <div class="p-4 bg-gradient-to-br from-rose-50 to-red-50 dark:from-gray-700 dark:to-gray-700 rounded-xl border border-rose-100 dark:border-gray-600">
                <div class="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wide">ملغاة</div>
                <div class="text-2xl font-bold text-rose-600 dark:text-rose-400">{{ $stats['cancelled'] ?? 0 }}</div>
            </div>
        </div>
        ...
        <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div class="flex items-end gap-2">
                    ...
                    @if(request()->anyFilled(['search', 'course_id', 'status', 'date_from', 'date_to']))
                        <a href="{{ route('instructor.lectures.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg font-medium transition-colors">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="font-medium">المدة:</span>
                            ...
                            @if($lecture->description)
                                <p class="text-sm text-gray-600 dark:text-gray-400 mt-3 line-clamp-2">{{ Str::limit($lecture->description, 150) }}</p>
                            @endif
                        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 text-center border border-gray-200 dark:border-gray-700">
            <div class="text-gray-500 dark:text-gray-400">
                <div class="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-sky-100 to-slate-100 dark:from-gray-700 dark:to-gray-700 rounded-xl flex items-center justify-center">
                    <i class="fas fa-chalkboard-teacher text-3xl text-sky-600 dark:text-sky-400"></i>
                </div>
                <p class="text-lg font-bold text-gray-900 dark:text-white mb-2">لا توجد محاضرات</p>
                <p class="text-sm mb-4">لم يتم إنشاء أي محاضرات بعد</p>
                <a href="{{ route('instructor.lectures.create') }}" 
