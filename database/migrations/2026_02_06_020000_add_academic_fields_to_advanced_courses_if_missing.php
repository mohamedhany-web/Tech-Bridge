...
{
    /**
     * إعادة إضافة academic_year_id و academic_subject_id إن تمت إزالتهما سابقاً
     * (مطلوب لصفحة تعديل الكورس)
     */
    public function up(): void
    {
        ...
        Schema::table('advanced_courses', function (Blueprint $table) {
            if (!Schema::hasColumn('advanced_courses', 'academic_year_id')) {
                $table->unsignedBigInteger('academic_year_id')->nullable()->after('instructor_id');
