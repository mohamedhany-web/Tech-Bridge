...
class AchievementController extends Controller
{
    ...
    /** قيم type المسموحة في جدول achievements (ENUM) */
    private const ACHIEVEMENT_TYPES = ['course_completion', 'exam_score', 'streak', 'points', 'custom'];

    private function mapCategoryToType(string $category): string
    {
        return in_array($category, self::ACHIEVEMENT_TYPES, true)
            ? $category
            : match ($category) {
                'exam_excellence' => 'exam_score',
                'attendance', 'assignment', 'other' => 'custom',
                default => 'custom',
            };
    }
